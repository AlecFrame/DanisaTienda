...
public class ProductoNuevoViewModel extends AndroidViewModel {
    ...
    public ProductoNuevoViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void crearProducto(String nombre, String descripcion, int idCategoria, String unidad, String precioS, String costoCompraS, String stockS, String stockBajoS){
        try {
            if (nombre.isBlank() | idCategoria<1 | precioS.isBlank() | stockS.isBlank() | stockBajoS.isBlank()) {
                    ...
                    call.enqueue(new Callback<>() {
                        ...
                        public void onResponse(Call<Producto> call, Response<Producto> response) {
                            if (response.isSuccessful()) {
                                ...
                                mToastMessage.postValue("Producto creado");
                                mBack.postValue(true);
                            } else {
                                mToastMessage.postValue("Error al crear el producto");
                        ...
                        public void onFailure(Call<Producto> call, Throwable t) {
                            mToastMessage.postValue("Error del servidor.");
                            mProcesoTerminado.postValue(true);
                            Log.d("CREAR PRODUCTO ERROR", "FOTO_URI: call: "+call);
                            Log.d("CREAR PRODUCTO ERROR", "FOTO_URI: throwable: "+t);
                        }
                    });
                } else {
                    Log.d("CREAR PRODUCTO", "DRAWABLESSS");

                    Call<Producto> call = servicio.crearProducto(nuevoProducto);
                    call.enqueue(new Callback<>() {
                        @Override
                        public void onResponse(Call<Producto> call, Response<Producto> response) {
                            if (response.isSuccessful()) {
                        ...
                        public void onFailure(Call<Producto> call, Throwable t) {
                            mToastMessage.postValue("Error del servidor.");
                            mProcesoTerminado.postValue(true);
                            Log.d("CREAR PRODUCTO ERROR", "DRAWABLE: call: "+call);
                            Log.d("CREAR PRODUCTO ERROR", "DRAWABLE: throwable: "+t);
                        }
                    });
                }
            }
            ...
            mProcesoTerminado.setValue(true);
            Log.d("CREAR PRODUCTO ERROR", "ERROR: "+e);
        }
    }
