...
public class ProductoAdapter extends RecyclerView.Adapter<ProductoAdapter.ProductoCardHolder>{
    ...
    @NonNull
    @Override
    public ProductoAdapter.ProductoCardHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = layoutInflater.inflate(R.layout.item_producto, parent, false);
        return new ProductoAdapter.ProductoCardHolder(itemView);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull ProductoAdapter.ProductoCardHolder holder, int position) {
        ...
        holder.card.setOnClickListener(v -> {
            ...
            Navigation.findNavController(v)
                    .navigate(R.id.action_inventarioFragment_to_productoDetalleFragment, bundle);
        });
    }
