...
public class CarritoProductoAdapter extends RecyclerView.Adapter<CarritoProductoAdapter.ProductoCardHolder>{
    private final List<Producto> productos;
    private final Context context;
    private final LayoutInflater layoutInflater;

    public CarritoProductoAdapter(List<Producto> productos, Context context, LayoutInflater layoutInflater) {
    ...
    @NonNull
    @Override
    public CarritoProductoAdapter.ProductoCardHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = layoutInflater.inflate(R.layout.item_producto, parent, false);
        return new ProductoCardHolder(itemView);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull CarritoProductoAdapter.ProductoCardHolder holder, int position) {
    ...
    public static class ProductoCardHolder extends RecyclerView.ViewHolder{
        ImageView foto;
        TextView nombre;
